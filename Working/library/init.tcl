...
#
# ActiveState ActiveTcl 8.5.3.0.286404 Win32/x86, Tue Jul 08 09:55:53 PDT 2008
#
...
namespace eval ::activestate {
	...
	maturity      {final}
	arch          {win32-ix86}
	buildtime,sec {1215536153}
	buildtime,fmt {Tue Jul 08 09:55:53 PDT 2008}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.5.3.0.286404 Win32/x86 @ Tue Jul 08 09:55:53 PDT 2008 / normal}
    }
}

package provide {ActiveTcl} {8.5.3.0.286404}
